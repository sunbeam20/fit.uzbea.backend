...
const salesReturnRoutes_1 = __importDefault(require("./routes/salesReturnRoutes"));
const purchaseReturnRoutes_1 = __importDefault(require("./routes/purchaseReturnRoutes"));
...
app.use("/api/salesreturn", salesReturnRoutes_1.default);
app.use("/api/purchasereturn", purchaseReturnRoutes_1.default);
app.use("/api/exchange", exchangeRoutes_1.default);
app.use("/api/service", serviceRoutes_1.default);
app.use("/api/sale", salesRoutes_1.default);
